...
func TestClassify(t *testing.T) {
	cases := []struct {
		...
		{"tidb write conflict 9007", &mysql.MySQLError{Number: 9007}, ClassTransient},
		{"tidb commit retry 8022", &mysql.MySQLError{Number: 8022}, ClassTransient},
		{"tidb schema changed 8028", &mysql.MySQLError{Number: 8028}, ClassTransient},
